...
## Using the App
To use the app, you will need to run ```app.ipynb``` locally or through Binder. You will not need to edit any code, but you will need to run the code as follows.
